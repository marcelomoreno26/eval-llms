...
_KWARGS_DESCRIPTION = """
Compute Prometheus Score by evaluating model responses based on predefined criteria.
Args:
    ...
    model_name: A string specifying the name of the language model to be used for evaluation.
Returns: float
        Average Prometheus Score across all predictions.
Examples:
        ...
        >>> score = metric.compute(predictions=predictions, references=references, contexts=contexts, model_name='model_name_here')
        >>> print(score)
            9.5
"""


# De momento no permite lo de previous conv
